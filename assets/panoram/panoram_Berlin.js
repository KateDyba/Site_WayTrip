...
for (let i=0; i<n; i++){  
  ...
  gsap.set(b, {
    ...
    transformOrigin:String("50% 50% -319%"), //adjust 3rd percentage to remove space between divs
    backgroundImage:'url(images/Europe/panorberlin.jpg)',
    backgroundPosition:i*-62.5+'px 0px' //offset should match width
  });  
}
