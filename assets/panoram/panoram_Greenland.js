...
for (let i=0; i<n; i++){  
  ...
  gsap.set(b, {
    ...
    transformOrigin:String("50% 50% -950%"), //adjust 3rd percentage to remove space between divs
    backgroundImage:'url(images/North_America/Greenland_panoram.jpg)',
    backgroundPosition:i*-188+'px 0px' //offset should match width
  });  
}
