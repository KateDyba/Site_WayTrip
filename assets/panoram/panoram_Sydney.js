...
for (let i=0; i<n; i++){  
  ...
  gsap.set(b, {
    ...
    transformOrigin:String("50% 50% -1000%"), //adjust 3rd percentage to remove space between divs
    backgroundImage:'url(images/Australia_Melbourne/Br_syd.jpeg)',
    backgroundPosition:i*-200+'px 0px' //offset should match width
  });  
}
