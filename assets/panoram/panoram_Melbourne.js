...
for (let i=0; i<n; i++){  
  ...
  gsap.set(b, {
    ...
    transformOrigin:String("50% 50% -900%"), //adjust 3rd percentage to remove space between divs
    backgroundImage:'url(images/Australia_Melbourne/park-in-melbourne.jpg)',
    backgroundPosition:i*-187.5+'px 0px' //offset should match width
  });  
}
